...
def get_columns():
	columns = [
		...
		# {"fieldname": "Sales Rep", "label": ("Appt Date and Time Schedule"), "fieldtype": "Data", "width": 200},
...
def get_data(filters):
	data=frappe.get_all(
		doctype="Opportunity",
		fields=["name","custom_first_name","custom_last_name","expected_closing_date","creation","notes_for_site_review"],
		filters=[{"opportunity_status":'Proposal'}])
	...
	if total_age>0 and total_no_of_jobs>0:
		...
		data.append({'custom_first_name':None,'expected_closing_date':None, 'creation':'Average Ageing','aging':average, 'notes_for_site_review':None,'timeline':None})
	return data
