...
def get_columns():
	columns = [
		...
		{"fieldname": "custom_maxfit_completed_by", "label": ("Completed By"), "fieldtype": "Data", "width": 200},
		{"fieldname": "aging", "label": ("Ageing"), "fieldtype": "Data", "width": 100},
		# {"fieldname": "custom_customer_availability", "label": ("Design Notes"), "fieldtype": "Data", "width": 200},
...
def get_data(filters):
	data=frappe.get_all(
		doctype="Opportunity",
		fields=["name","custom_first_name","custom_last_name","expected_closing_date","custom_maxfit_completed_by","creation","custom_customer_availability"],
		filters=[{"opportunity_status":'Maxfit Completed'}])
	...
	if total_age>0 and total_no_of_jobs>0:
		...
		data.append({'custom_first_name':None,'expected_closing_date': None, 'custom_maxfit_completed_by': 'Average Ageing', 'creation':None, 'custom_customer_availability': None, 'aging': average, 'timeline':None})
	return data
