...
def get_columns():
	columns = [
		...
		{"fieldname": "custom_contract_sent_by", "label": ("Sent By"), "fieldtype": "Data", "width": 200},
...
def get_data(filters):
	data=frappe.get_all(
		doctype="Opportunity",
		fields=["name","custom_first_name","custom_last_name","expected_closing_date","custom_contract_sent_by","creation"],
		filters=[{"opportunity_status":'Contract Sent'}])
	...
	if total_age>0 and total_no_of_jobs>0:
		...
		data.append({'custom_first_name':None,'expected_closing_date': None,'creation':'Average Ageing','aging': average,'timeline':None})
	return data
